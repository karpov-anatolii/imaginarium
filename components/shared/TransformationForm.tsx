...
const TransformationForm = ({
  ...
  const correctNewTransformation = () => {
    ...
    //   return { ...rest, remove: { prompt: prompt } };
    // }
    if (replaceMode && newTransformation?.remove) {
      const { remove, ...rest } = newTransformation;
      return { ...rest };
  ...
  const onTransformHandler = async () => {
    ...
    console.log("correctNewTransformation()=", correctNewTransformation());
    //setNewTransformation(correctNewTransformation());
    ...
    // setTransformationConfig(
    //   deepMergeObjects(newTransformation, transformationConfig) // is generated by ChatGPT
    // );
  ...
  useEffect(() => {
    ...
    // setImage(initCldObj);
    // setImageCldTranspObj(initCldObj);
    // setBgImageCldObj(bgCldObj);
